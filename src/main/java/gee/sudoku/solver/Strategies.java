...
public enum Strategies {
	NAKED_PAIR, NAKED_TRIPLET, NAKED_QUAD, NAKED_QUINT, NAKED_SEXTE, HIDDEN_PAIR, HIDDEN_TRIPLET, HIDDEN_QUAD, HIDDEN_QUINT, X_WING_COL, X_WING_ROW, GUESSING_FIRST, GUESSING_SECOND, SOLE_OPTION, REMOVE_OPTIONS, CANDIDATE_COL, CANDIDATE_ROW, Y_WING, HUMAN, SWORDFISH;
	String description;
